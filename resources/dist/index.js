...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/ui/templates/pagePreview/pagePreview.html":
/*!*********************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/ui/templates/pagePreview/pagePreview.html ***!
  \*********************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ("<a class=\"mwe-popups-discreet\">\n</a>\n<a class=\"mwe-popups-extract\">\n</a>\n<footer>\n    <a class='mwe-popups-settings-icon'>\n        <span class=\"mw-ui-icon mw-ui-icon-small mw-ui-icon-element mw-ui-icon-popups-settings\"></span>\n    </a>\n</footer>");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/ui/templates/popup/popup.html":
/*!*********************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/ui/templates/popup/popup.html ***!
  \*********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class='mwe-popups' aria-hidden>\n    <div class='mwe-popups-container'></div>\n</div>");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/ui/templates/preview/preview.html":
/*!*************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/ui/templates/preview/preview.html ***!
  \*************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class='mw-ui-icon mw-ui-icon-element'></div>\n<strong class='mwe-popups-title'></strong>\n<a class='mwe-popups-extract'>\n    <span class='mwe-popups-message'></span>\n</a>\n<footer>\n    <a class='mwe-popups-read-link'></a>\n</footer>\n");
...
var // See the following for context around this value.
//
...
function fetch(gateway, title, el, token, type) {
  ...
  return function (dispatch) {
    ...
    var chain = xhr.then(function (result) {
      ...
      var fetchType = data && data.textStatus && data.textStatus === 'abort' ? _actionTypes__WEBPACK_IMPORTED_MODULE_0__["default"].FETCH_ABORTED : _actionTypes__WEBPACK_IMPORTED_MODULE_0__["default"].FETCH_FAILED;
      exception.data = data;
      dispatch({
        type: fetchType,
        el: el,
...
/* harmony import */ var _pageviews__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pageviews */ "./src/changeListeners/pageviews.js");
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./render */ "./src/changeListeners/render.js");
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./settings */ "./src/changeListeners/settings.js");
/* harmony import */ var _statsv__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./statsv */ "./src/changeListeners/statsv.js");
/* harmony import */ var _syncUserSettings__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./syncUserSettings */ "./src/changeListeners/syncUserSettings.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  pageviews: _pageviews__WEBPACK_IMPORTED_MODULE_2__["default"],
  render: _render__WEBPACK_IMPORTED_MODULE_3__["default"],
  settings: _settings__WEBPACK_IMPORTED_MODULE_4__["default"],
  statsv: _statsv__WEBPACK_IMPORTED_MODULE_5__["default"],
  syncUserSettings: _syncUserSettings__WEBPACK_IMPORTED_MODULE_6__["default"]
});
...
function makeTitleInExtractBold(extract, title) {
  ...
  var escapedTitle = mw.util.escapeRegExp(title);
...
function createReferenceGateway() {
  ...
  function fetchPreviewForTitle(title, el) {
    ...
    if (!$referenceText.length || // Skip references that don't contain anything but whitespace, e.g. a single &nbsp;
...
function getPageviewTracker(config, loader, trackerGetter, sendBeacon) {
  var pageviewTracker = function pageviewTracker(topic, eventData) {
    ...
    var dependencies = ['ext.eventLogging'];
...
var EXCLUDED_LINK_SELECTORS = ['.extiw', '.image', '.new', '.internal', '.external', '.mw-cite-backlink a', '.oo-ui-buttonedElement-button', '.ve-ce-surface a', // T259889
'.cancelLink a'];
/**
...
function registerChangeListeners(store, registerActions, userSettings, settingsDialog, previewBehavior, statsvTracker, eventLoggingTracker, pageviewTracker, callbackCurrentTimestamp) {
  Object(_changeListener__WEBPACK_IMPORTED_MODULE_7__["default"])(store, _changeListeners__WEBPACK_IMPORTED_MODULE_14__["default"].footerLink(_actions__WEBPACK_IMPORTED_MODULE_15__));
  ...
  Object(_changeListener__WEBPACK_IMPORTED_MODULE_7__["default"])(store, _changeListeners__WEBPACK_IMPORTED_MODULE_14__["default"].statsv(registerActions, statsvTracker));
  ...
  Object(_changeListener__WEBPACK_IMPORTED_MODULE_7__["default"])(store, _changeListeners__WEBPACK_IMPORTED_MODULE_14__["default"].settings(registerActions, settingsDialog));
  Object(_changeListener__WEBPACK_IMPORTED_MODULE_7__["default"])(store, _changeListeners__WEBPACK_IMPORTED_MODULE_14__["default"].eventLogging(registerActions, eventLoggingTracker, callbackCurrentTimestamp));
  Object(_changeListener__WEBPACK_IMPORTED_MODULE_7__["default"])(store, _changeListeners__WEBPACK_IMPORTED_MODULE_14__["default"].pageviews(registerActions, pageviewTracker));
}
/*
...
(function init() {
  ...
  if (mw.user.isAnon() || mw.user.options.get('popups') === '1') {
    selectors.push("#mw-content-text a[href][title]:not(".concat(excludedLinksSelector, ")"));
  ...
  if (mw.config.get('wgPopupsReferencePreviews') && // T243822: Temporarily disabled in the mobile skin
  ...
  var validLinkSelector = selectors.join(', ');
  Object(_ui_renderer__WEBPACK_IMPORTED_MODULE_10__["init"])();
  var eligibleElements = document.querySelectorAll(validLinkSelector);
  var excludedLinksSelector = EXCLUDED_LINK_SELECTORS.join(', ');

  var addPopupEventHandlers = function addPopupEventHandlers(target) {
    var _gateways;

    // Disable default browser tooltip
    var gateway;
    var type;
    var mwTitle = Object(_title__WEBPACK_IMPORTED_MODULE_9__["fromElement"])(target, mw.config);
    if (!mwTitle) return;
    target.removeAttribute('title');
    var gateways = (_gateways = {}, _defineProperty(_gateways, _preview_model__WEBPACK_IMPORTED_MODULE_19__["previewTypes"].TYPE_PAGE, pagePreviewGateway), _defineProperty(_gateways, _preview_model__WEBPACK_IMPORTED_MODULE_19__["previewTypes"].TYPE_REFERENCE, referenceGateway), _gateways);
    ...
    var showPopup = function showPopup(_ref) {
      ...
      if (typeof gateway === 'undefined') {
        type = Object(_preview_model__WEBPACK_IMPORTED_MODULE_19__["getPreviewType"])(target, mw.config, mwTitle);
    ...
    var hidePopup = function hidePopup() {
      return boundActions.abandon();
    };

    var getNearestClientRect = function getNearestClientRect(rects, y) {
      return rects.length === 1 ? rects[0] : Array.from(rects).reduce(function (result, rect) {
        var deltaY = Math.abs(y - rect.top + y - rect.bottom);
        return result.deltaY < deltaY ? result : {
          rect: rect,
          deltaY: deltaY
        };
      }, {
    ...
    target.addEventListener('mouseover', function (event) {
      var maxLinkWidthForCenteredPointer = 28; // Link with roughly < 4 chars.

      var clientY = event.clientY;
      var clientRects = target.getClientRects();
      var clientRect = getNearestClientRect(clientRects, clientY);
      var clientX = clientRect.width > maxLinkWidthForCenteredPointer ? event.clientX : clientRect.left + targetRect.width / 2;
      showPopup({
        eventType: 'mouse',
        clientX: clientX,
        clientY: clientY,
    ...
    target.addEventListener('keyup', function (event) {
      ...
      var _target$getClientRect = target.getClientRects(),
          _target$getClientRect2 = _slicedToArray(_target$getClientRect, 1),
          clientRect = _target$getClientRect2[0];
    ...
    target.addEventListener('click', function (event) {
      if (_preview_model__WEBPACK_IMPORTED_MODULE_19__["previewTypes"].TYPE_PAGE === (type || Object(_preview_model__WEBPACK_IMPORTED_MODULE_19__["getPreviewType"])(target, mw.config, mwTitle))) {
        boundActions.linkClick(target);
      }
    });
  };

  Array.from(eligibleElements).filter(function (element) {
    return !element.matches(excludedLinksSelector);
...
function isEnabled(user, config, window) {
  ...
  return config.get('wgPopupsEventLogging') && window.navigator && typeof window.navigator.sendBeacon === 'function';
}
...
function getPreviewType(el, config, title) {
  ...
  if (title.getFragment() && config.get('wgPopupsReferencePreviews') && // eslint-disable-next-line no-jquery/no-class-state
...
function isSelfLink(title, config) {
  return title.getNamespaceId() === config.get('wgNamespaceNumber') && title.getMainText() === config.get('wgTitle');
}
/**
...
function preview(state, action) {
  ...
  switch (action.type) {
    ...
    case _actionTypes__WEBPACK_IMPORTED_MODULE_0__["default"].FETCH_ABORTED:
    case _actionTypes__WEBPACK_IMPORTED_MODULE_0__["default"].ABANDON_END:
...
function getTitle(href, config) {
  ...
  if (!queryLength) {
    var pattern = mw.util.escapeRegExp(config.get('wgArticlePath')).replace('\\$1', '([^?#]+)'),
...
/*!****************************!*\
  !*** ./src/ui/renderer.js ***!
  \****************************/
/*! exports provided: init, render, createPreviewWithType, show, bindBehavior, hide */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _thumbnail__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./thumbnail */ "./src/ui/thumbnail.js");
/* harmony import */ var _preview_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../preview/model */ "./src/preview/model.js");
/* harmony import */ var _templates_preview_preview__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./templates/preview/preview */ "./src/ui/templates/preview/preview.js");
/* harmony import */ var _templates_referencePreview_referencePreview__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./templates/referencePreview/referencePreview */ "./src/ui/templates/referencePreview/referencePreview.js");
/* harmony import */ var _templates_pagePreview_pagePreview__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./templates/pagePreview/pagePreview */ "./src/ui/templates/pagePreview/pagePreview.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest(); }
...
function createPreviewWithType(model) {
  switch (model.type) {
    ...
    case _preview_model__WEBPACK_IMPORTED_MODULE_2__["previewTypes"].TYPE_DISAMBIGUATION:
...
function createPagePreview(model) {
  var thumbnail = Object(_thumbnail__WEBPACK_IMPORTED_MODULE_1__["createThumbnail"])(model.thumbnail),
      hasThumbnail = thumbnail !== null;
  return {
    el: Object(_templates_pagePreview_pagePreview__WEBPACK_IMPORTED_MODULE_5__["renderPagePreview"])(model, thumbnail),
...
function createEmptyPreview(model) {
  ...
  return {
    el: Object(_templates_preview_preview__WEBPACK_IMPORTED_MODULE_3__["renderPreview"])(model, showTitle, extractMsg, linkMsg),
    hasThumbnail: false,
    isTall: false
  };
}
...
function createReferencePreview(model) {
  return {
    el: Object(_templates_referencePreview_referencePreview__WEBPACK_IMPORTED_MODULE_4__["renderReferencePreview"])(model),
    hasThumbnail: false,
    isTall: false
  };
}
...
function _show(preview, event, $link, behavior, token, container, dir) {
  var flippedX = event.clientX > event.innerWidth / 2;
  var flippedY = event.clientY > event.innerHeight / 2;
  var offsetCorrection = event.eventType === 'mouse' ? 18 : 0;
  var layout = {
  ...
  var previewElement = preview.el[0];
  var isTall = preview.isTall,
      hasThumbnail = preview.hasThumbnail,
      thumbnail = preview.thumbnail;
  var style = previewElement.style,
      dataset = previewElement.dataset;
  style.setProperty('--link-top', "".concat(Math.round(layout.top), "px"));
  style.setProperty('--link-bottom', "".concat(Math.round(layout.bottom), "px"));
  style.setProperty('--offset-x', "".concat(layout.pageX, "px"));
  ...
  container.appendChild(previewElement); // Trigger fading effect for reference previews after the popup has been rendered
  ...
  previewElement.addEventListener('transitionend', function () {
...
function bindBehavior(element, behavior) {
  ...
  var settingsIcon = element.querySelector('.mwe-popups-settings-icon');
...
/*!*****************************************************!*\
  !*** ./src/ui/templates/pagePreview/pagePreview.js ***!
  \*****************************************************/
/*! exports provided: renderPagePreview */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _raw_loader_pagePreview_html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! raw-loader!./pagePreview.html */ "./node_modules/raw-loader/dist/cjs.js!./src/ui/templates/pagePreview/pagePreview.html");
/**
 * @module pagePreview
 */
...
var cloneFragment = Object(_templateUtil__WEBPACK_IMPORTED_MODULE_1__["createTemplate"])(_raw_loader_pagePreview_html__WEBPACK_IMPORTED_MODULE_2__["default"]);
var preview = null;
...
function renderPagePreview(model, thumbnail) {
  ...
  var discreet = preview.querySelector('.mwe-popups-discreet');
  var extract = preview.querySelector('.mwe-popups-extract');
  ...
  var footer = preview.querySelector('footer');
  ...
  if (model.extract) {
    ...
    model.extract.forEach(function (e) {
      return extract.appendChild(e);
    });
  }

  var $el = Object(_popup_popup__WEBPACK_IMPORTED_MODULE_0__["renderPopup"])(model.type, preview);
  previousElement = $el;
  return $el;
}
...
/* harmony import */ var _raw_loader_popup_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./popup.html */ "./node_modules/raw-loader/dist/cjs.js!./src/ui/templates/popup/popup.html");
/**
 * @module popup
 */


var cloneFragment = Object(_templateUtil__WEBPACK_IMPORTED_MODULE_0__["createTemplate"])(_raw_loader_popup_html__WEBPACK_IMPORTED_MODULE_1__["default"]);
/**
...
var popup = null;
function renderPopup(type, innerElement) {
  popup = popup || cloneFragment().querySelector('.mwe-popups');
  popup.classList.add("mwe-popups-type-".concat(type));
  var container = popup.querySelector('.mwe-popups-container');
...
/* harmony import */ var _popup_popup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../popup/popup */ "./src/ui/templates/popup/popup.js");
/* harmony import */ var _templateUtil__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../templateUtil */ "./src/ui/templates/templateUtil.js");
/* harmony import */ var _raw_loader_preview_html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! raw-loader!./preview.html */ "./node_modules/raw-loader/dist/cjs.js!./src/ui/templates/preview/preview.html");
/**
 * @module preview
 */
...
var cloneFragment = Object(_templateUtil__WEBPACK_IMPORTED_MODULE_1__["createTemplate"])(_raw_loader_preview_html__WEBPACK_IMPORTED_MODULE_2__["default"]);
/**
 * @param {ext.popups.PagePreviewModel} model
...
function renderPreview(model, showTitle, extractMsg, linkMsg) {
  ...
  var preview = cloneFragment();
  var titleElement = preview.querySelector('.mwe-popups-title');
  var linkElement = preview.querySelector('.mwe-popups-read-link');
  preview.querySelector('.mw-ui-icon').classList.add("mw-ui-icon-preview-".concat(model.type));
  ...
  return Object(_popup_popup__WEBPACK_IMPORTED_MODULE_0__["renderPopup"])(model.type, preview);
}
...
var LOGGING_SCHEMA = 'event.ReferencePreviewsPopups';
var isTracking = false;
$(function () {
  if (mw.config.get('wgPopupsReferencePreviews') && navigator.sendBeacon && mw.config.get('wgIsArticle') && !isTracking) {
    isTracking = true;
...
function renderReferencePreview(model) {
  ...
  $el.find('.mwe-popups-extract a[href][class~="external"]:not([target])').each(function (i, a) {
  ...
  $el.find('.mw-collapsible').replaceWith($('<div>').addClass('mwe-collapsible-placeholder').append($('<span>').addClass('mw-ui-icon mw-ui-icon-element mw-ui-icon-infoFilled'), $('<div>').addClass('mwe-collapsible-placeholder-label').text(mw.msg('popups-refpreview-collapsible-placeholder')))); // Undo remaining effects from the jquery.tablesorter.js plugin

  $el.find('table.sortable').removeClass('sortable jquery-tablesorter').find('.headerSort').removeClass('headerSort').attr({
    tabindex: null,
    title: null
  });

  if (isTracking) {
    $el.find('.mw-parser-output').on('click', 'a', function () {
      mw.track(LOGGING_SCHEMA, {
  ...
  $el.find('.mwe-popups-scroll').on('scroll', function (e) {
    ...
    if (isTracking) {
      ...
      if (element.scrollTop > 0 && !element.isScrollRecorded) {
        mw.track(LOGGING_SCHEMA, {
          action: 'scrolled'
        });
    ...
    $extract.find('.mwe-popups-fade').css({
      bottom: hasHorizontalScroll ? "".concat(scrollbarHeight, "px") : 0,
      right: hasVerticalScroll ? "".concat(scrollbarWidth, "px") : 0
    });
...
/*!******************************************!*\
  !*** ./src/ui/templates/templateUtil.js ***!
  \******************************************/
/*! exports provided: escapeHTML, createTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*****************************!*\
  !*** ./src/ui/thumbnail.js ***!
  \*****************************/
/*! exports provided: SIZES, createThumbnail */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function createThumbnail(rawThumbnail) {
  ...
  !tall && thumbWidth < SIZES.landscapeImage.w || // Image too small for portrait display
  tall && thumbHeight < SIZES.portraitImage.h || // These characters in URL that could inject CSS and thus JS
  rawThumbnail.source.indexOf('\\') > -1 || rawThumbnail.source.indexOf('\'') > -1 || rawThumbnail.source.indexOf('"') > -1) {
    return null;
  }
